                                        ...
                                        <div class="col-lg-6">
                                            <form role="form" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Nhập mã danh mục" name="madanhmuc" required>
                                                ...
                                                <button type="submit" class="btn btn-default" name="themdanhmuc">Thực hiện</button>
...
<?php 
    ...
    if(isset($_REQUEST['themdanhmuc'])){
        ...
        if(getimagesize($_FILES['image']['tmp_name'])==false){
            ...
            $sql = "INSERT INTO DANHMUCSANPHAM VALUES ('$madanhmuc','$tendanhmuc','$image','$mota','$ngaybatdau')";
            // echo $sql;
            $query = $conn->query($sql);
            if($query){
                echo "<script type='text/javascript'>alert('thành công'); window.location.href='themdanhmuc.php';</script>";
            }else{
